...
-- PROMPT Drop PublishingHouse user
-- drop user PublishingHouse cascade;
   
PROMPT Create user PublishingHouse
CREATE USER PublishingHouse IDENTIFIED BY &&PublishingHouse_password PASSWORD EXPIRE ACCOUNT LOCK /* DEFAULT TABLESPACE USERS  TEMPORARY TABLESPACE TEMP */;
GRANT CREATE SESSION, RESOURCE, CREATE VIEW, CREATE MATERIALIZED VIEW, CREATE SYNONYM, UNLIMITED TABLESPACE TO PublishingHouse;
...
grant ALL on utils to PublishingHouse with grant option;

set define on
prompt connecting to PublishingHouse
...
CREATE TABLE Authors (
  Author_ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  Name VARCHAR2(50 CHAR) NOT NULL,
  Date_of_birth VARCHAR2(200 CHAR) NOT NULL,
  Bio VARCHAR2(1000 CHAR) NOT NULL,
  Nationality VARCHAR2(30 CHAR) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Authors__55B9F6DF44987F4A on table Authors ... 
ALTER TABLE Authors
ADD CONSTRAINT PK__Authors__55B9F6DF44987F4A PRIMARY KEY
(
  Author_ID
)
ENABLE
...
GRANT ALL ON Authors TO ROLE_lab6;
-- DROP TABLE Publishers CASCADE CONSTRAINTS;


PROMPT Creating Table Publishers ...
CREATE TABLE Publishers (
  Publisher_ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  Name VARCHAR2(50 CHAR) NOT NULL,
  Address RAW(8000),
  Contact_info VARCHAR2(50 CHAR) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Publishe__F9F45A64628A9709 on table Publishers ... 
ALTER TABLE Publishers
ADD CONSTRAINT PK__Publishe__F9F45A64628A9709 PRIMARY KEY
(
  Publisher_ID
)
ENABLE
...
GRANT ALL ON Publishers TO ROLE_lab6;
-- DROP TABLE Distributors CASCADE CONSTRAINTS;


PROMPT Creating Table Distributors ...
CREATE TABLE Distributors (
  Distributor_ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  Name VARCHAR2(50 CHAR) NOT NULL,
...
PROMPT Creating Primary Key Constraint PK__Distribu__DC36EB0CC7A1A32E on table Distributors ... 
ALTER TABLE Distributors
ADD CONSTRAINT PK__Distribu__DC36EB0CC7A1A32E PRIMARY KEY
(
  Distributor_ID
)
ENABLE
...
GRANT ALL ON Distributors TO ROLE_lab6;
-- DROP TABLE Categories CASCADE CONSTRAINTS;


PROMPT Creating Table Categories ...
CREATE TABLE Categories (
  Category_ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  Category_Name NVARCHAR2(50) NOT NULL,
  ParentCategoryID NUMBER(10,0)
);


PROMPT Creating Primary Key Constraint PK__Categori__6DB38D4E936D6A0A on table Categories ... 
ALTER TABLE Categories
ADD CONSTRAINT PK__Categori__6DB38D4E936D6A0A PRIMARY KEY
(
  Category_ID
)
ENABLE
...
GRANT ALL ON Categories TO ROLE_lab6;
...
CREATE TABLE Books (
  ...
  Publication_date VARCHAR2(200 CHAR) NOT NULL,
...
PROMPT Creating Primary Key Constraint PK__Books__447D36EB7E7A30C5 on table Books ... 
ALTER TABLE Books
ADD CONSTRAINT PK__Books__447D36EB7E7A30C5 PRIMARY KEY
(
  ISBN
)
ENABLE
...
GRANT ALL ON Books TO ROLE_lab6;
-- DROP TABLE Sales CASCADE CONSTRAINTS;


PROMPT Creating Table Sales ...
CREATE TABLE Sales (
  Sales_ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  ISBN VARCHAR2(20 CHAR) NOT NULL,
  Sales_date VARCHAR2(200 CHAR) NOT NULL,
  Copies_sold NUMBER(10,0) NOT NULL,
  Revenue NUMBER(10,2) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Sales__32123EFACAAED6B2 on table Sales ... 
ALTER TABLE Sales
ADD CONSTRAINT PK__Sales__32123EFACAAED6B2 PRIMARY KEY
(
  Sales_ID
)
ENABLE
...
GRANT ALL ON Sales TO ROLE_lab6;
-- DROP TABLE Inventory CASCADE CONSTRAINTS;


PROMPT Creating Table Inventory ...
CREATE TABLE Inventory (
  Inventory_ID NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1 INCREMENT BY 1 MINVALUE 1 NOMAXVALUE ,
  ISBN VARCHAR2(20 CHAR) NOT NULL,
  Copies_in_stock NUMBER(10,0) NOT NULL,
  Location VARCHAR2(50 CHAR) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Inventor__2B65F40B7E203AB7 on table Inventory ... 
ALTER TABLE Inventory
ADD CONSTRAINT PK__Inventor__2B65F40B7E203AB7 PRIMARY KEY
(
  Inventory_ID
)
ENABLE
...
GRANT ALL ON Inventory TO ROLE_lab6;
-- DROP TABLE Categories_Set CASCADE CONSTRAINTS;


PROMPT Creating Table Categories_Set ...
CREATE TABLE Categories_Set (
  CategoryID NUMBER(10,0) NOT NULL,
  CategoryName NVARCHAR2(50) NOT NULL,
  LeftValue NUMBER(10,0) NOT NULL,
  RightValue NUMBER(10,0) NOT NULL
);


PROMPT Creating Primary Key Constraint PK__Categori__19093A2BBFBE07F6 on table Categories_Set ... 
ALTER TABLE Categories_Set
ADD CONSTRAINT PK__Categori__19093A2BBFBE07F6 PRIMARY KEY
(
  CategoryID
)
ENABLE
...
GRANT ALL ON Categories_Set TO ROLE_lab6;
PROMPT Creating Index MySpatialIndex on Publishers ...
CREATE INDEX MySpatialIndex ON Publishers
(
  Address
) 
;
...
alter session set current_schema=PublishingHouse;
set define off
CREATE OR REPLACE FORCE VIEW Books_by_category
-----------------VIEWS-----------------------------------------
...
GRANT ALL ON Books_by_category TO ROLE_lab6;
CREATE OR REPLACE FORCE VIEW Books_by_publisher 
AS 
   SELECT NAME ,
          Title ,
          Author_id ,
...
GRANT ALL ON Books_by_publisher TO ROLE_lab6;
CREATE OR REPLACE FORCE VIEW BooksWithAuthorsAndCategories 
AS 
   SELECT Title ,
          NAME ,
          Category_name 
...
GRANT ALL ON BooksWithAuthorsAndCategories TO ROLE_lab6;
CREATE OR REPLACE FUNCTION fnGetAverageRevenue
RETURN NUMBER
AS
   v_averageRevenue NUMBER(10,2);

BEGIN
   SELECT AVG(Revenue)  

     INTO v_averageRevenue
     FROM Sales ;
   RETURN v_averageRevenue;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON fnGetAverageRevenue TO ROLE_lab6;
CREATE OR REPLACE FUNCTION fnGetAverageRevenueByCategory
(
...
BEGIN
   SELECT AVG(Revenue)  
     ...
     INTO v_averageRevenue
     FROM Sales 
            JOIN Books    ON Sales.ISBN = Books.ISBN
            JOIN Categories    ON Books.Category_ID = Categories.Category_ID
    WHERE  Category_name = v_categoryName;
   RETURN v_averageRevenue;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON fnGetAverageRevenueByCategory TO ROLE_lab6;
/*Global Temporary Tables:1 *//* Translation Extracted DDL For Required Objects*/
CREATE GLOBAL TEMPORARY TABLE tt_fnGetBooksByCategory
AS (
   SELECT Title ,
   Author_id ,
   Publication_date ,
...
/
CREATE OR REPLACE PACKAGE fnGetBooksByCategory_pkg
AS
   TYPE tt_fnGetBooksByCategory_type IS TABLE OF tt_fnGetBooksByCategory%ROWTYPE;
END;
/


CREATE OR REPLACE FUNCTION fnGetBooksByCategory
(
  v_Category_name IN VARCHAR2
)
RETURN fnGetBooksByCategory_pkg.tt_fnGetBooksByCategory_type PIPELINED
AS
   v_temp SYS_REFCURSOR;
   v_temp_1 TT_FNGETBOOKSBYCATEGORY%ROWTYPE;

BEGIN
   DELETE tt_fnGetBooksByCategory;
   
   INSERT INTO tt_fnGetBooksByCategory
      SELECT Title ,
             Author_id ,
             Publication_date ,
             DESCRIPTION ,
...
END;
/
GRANT ALL ON fnGetBooksByCategory TO ROLE_lab6;
CREATE OR REPLACE PROCEDURE AddSubordinateCategory
(
  v_CategoryName IN NVARCHAR2,
  v_ParentCategoryID IN NUMBER
)
AS
...
BEGIN
   ...
   INSERT INTO Categories
     ( Category_Name, ParentCategoryID )
     VALUES ( v_CategoryName, v_ParentCategoryID );

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON AddSubordinateCategory TO ROLE_lab6;
CREATE OR REPLACE PROCEDURE GetCategoryDescendants
(
...
BEGIN
   ...
   OPEN  v_cursor FOR
      SELECT CategoryName 
        FROM Categories_Set 
       WHERE  LeftValue >= ( SELECT LeftValue 
                             FROM Categories_Set 
                              WHERE  CategoryID = v_CategoryID )
                AND RightValue <= ( SELECT RightValue 
                                    FROM Categories_Set 
                                     WHERE  CategoryID = v_CategoryID )
...
END;
/
GRANT ALL ON GetCategoryDescendants TO ROLE_lab6;
CREATE OR REPLACE PROCEDURE GetSubordinateCategories
(
  v_CategoryID IN NUMBER
)
AS
...
BEGIN
   ...
   OPEN  v_cursor FOR
      WITH CategoryHierarchy ( CategoryID,
                               CategoryName,
                               ParentCategoryID,
                               LEVEL ) AS ( SELECT Category_ID ,
                                                   Category_Name ,
                                                   ParentCategoryID ,
                                                   0 LEVEL_  
     FROM Categories 
...
END;
/
GRANT ALL ON GetSubordinateCategories TO ROLE_lab6;
CREATE OR REPLACE PROCEDURE MoveSubordinateBranch
(
  v_CategoryID IN NUMBER,
  v_NewParentCategoryID IN NUMBER
)
AS
...
BEGIN
   ...
   UPDATE Categories
      SET ParentCategoryID = v_NewParentCategoryID
    WHERE  Category_ID IN ( SELECT Categories.Category_ID 
                            FROM Categories 
                             WHERE  Categories.Category_ID = v_CategoryID
                                      OR Categories.ParentCategoryID = v_CategoryID )
   ;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON MoveSubordinateBranch TO ROLE_lab6;
CREATE OR REPLACE PROCEDURE spGetBooksByCategory
(
  v_Category_name IN VARCHAR2
)
AS
...
END;
/
GRANT ALL ON spGetBooksByCategory TO ROLE_lab6;
CREATE OR REPLACE PROCEDURE spUpdateInventory
(
  v_ISBN IN VARCHAR2,
  v_Copies_in_stock IN NUMBER
)
AS
...
BEGIN
   ...
   UPDATE Inventory
      SET Copies_in_stock = v_Copies_in_stock
    WHERE  ISBN = v_ISBN;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON spUpdateInventory TO ROLE_lab6;
CREATE OR REPLACE PROCEDURE spUpdateOrders
(
  v_ISBN IN VARCHAR2,
  v_Copies_ordered IN NUMBER
)
AS
...
BEGIN
   ...
   UPDATE Orders
      SET Copies_ordered = v_Copies_ordered
    WHERE  ISBN = v_ISBN;

EXCEPTION WHEN OTHERS THEN utils.handleerror(SQLCODE,SQLERRM);
END;
/
GRANT ALL ON spUpdateOrders TO ROLE_lab6;
set define on
prompt connecting to PublishingHouse
alter session set current_schema=PublishingHouse;
set define off
PROMPT Creating Foreign Key Constraint FK__Inventory__ISBN__7167D3BD on table Books...
ALTER TABLE Inventory
ADD CONSTRAINT FK__Inventory__ISBN__7167D3BD FOREIGN KEY
(
  ISBN
)
REFERENCES Books
...
PROMPT Creating Foreign Key Constraint FK__Sales__ISBN__6E8B6712 on table Books...
ALTER TABLE Sales
ADD CONSTRAINT FK__Sales__ISBN__6E8B6712 FOREIGN KEY
(
  ISBN
)
REFERENCES Books
...
PROMPT Creating Foreign Key Constraint FK__Books__Publisher__69C6B1F5 on table Publishers...
ALTER TABLE Books
ADD CONSTRAINT FK__Books__Publisher__69C6B1F5 FOREIGN KEY
(
  Publisher_ID
)
...
PROMPT Creating Foreign Key Constraint FK__Books__Distribut__6ABAD62E on table Distributors...
ALTER TABLE Books
ADD CONSTRAINT FK__Books__Distribut__6ABAD62E FOREIGN KEY
(
  Distributor_ID
)
...
PROMPT Creating Foreign Key Constraint FK_Categories_ParentCategoryID on table Categories...
ALTER TABLE Categories
ADD CONSTRAINT FK_Categories_ParentCategoryID FOREIGN KEY
(
  ParentCategoryID
)
...
PROMPT Creating Foreign Key Constraint FK__Books__Category___68D28DBC on table Categories...
ALTER TABLE Books
ADD CONSTRAINT FK__Books__Category___68D28DBC FOREIGN KEY
(
  Category_ID
)
REFERENCES Categories
...
PROMPT Creating Foreign Key Constraint FK__Books__Author_id__6BAEFA67 on table Authors...
ALTER TABLE Books
ADD CONSTRAINT FK__Books__Author_id__6BAEFA67 FOREIGN KEY
(
  Author_id
)
REFERENCES Authors
...
ALTER VIEW Books_by_category COMPILE;

ALTER VIEW Books_by_publisher COMPILE;

ALTER VIEW BooksWithAuthorsAndCategories COMPILE;
